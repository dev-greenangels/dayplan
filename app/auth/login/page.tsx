...
export default function LoginPage() {
  ...
  return (
    <div
      className="page-bg flex min-h-screen items-center justify-center px-4"
      style={{
    ...
    >
      ...
      <div
        className="relative w-full max-w-sm animate-[fadeInUp_0.5s_ease_both]"
      ...
      >
        ...
        >
          {sent ? (
            <div className="text-center" style={{ animation: 'fadeInUp 0.3s ease both' }}>
            ...
            <>
              ...
              <button
                ...
                className="flex w-full items-center justify-center gap-3 rounded-xl border border-border/70 bg-white/80 px-4 py-2.5 text-sm font-medium text-foreground shadow-sm transition hover:bg-white hover:shadow-md disabled:opacity-60"
              >
                {googleLoading ? (
              ...
              <form onSubmit={handleOTP} className="flex flex-col gap-3">
                ...
                <button
                  ...
                  className="rounded-xl bg-primary px-4 py-2.5 text-sm font-semibold text-primary-foreground shadow shadow-primary/25 transition hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {loading ? 'Надсилаємо...' : 'Отримати OTP код'}
                </button>
              </form>
            </>
          )}
